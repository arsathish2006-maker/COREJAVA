...
public class Jdbc_LibraryManagementSystem {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    PreparedStatement insertStmt = con.prepareStatement("INSERT INTO books (id,title) VALUES (?,?)");
                ...
                case 3:
                    ...
                    PreparedStatement updateStmt = con.prepareStatement("UPDATE books SET title = ? WHERE id = ?");
